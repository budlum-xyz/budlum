...
pub enum ServeEngine {
    ...
    ///
    /// a resident-batch engine ve a resident-graph engine modelin tamamının VRAM'de yerleşik olmasını ister; bu,
    ...
    /// operatör olabilir.
    ///
    /// Ayrı süreç olarak, a model vendor-uyumlu uç üzerinden konuşulur; kod
