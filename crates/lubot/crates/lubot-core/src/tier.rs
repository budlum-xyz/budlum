...
//!
//! Karar (2026-08-13): the upstream vendor'in varyant adları (Flash/Pro) Lubot
//! katmanında kullanılmaz; kendi adlarımız geçerlidir:
//!
//! - `Light`  ← base-checkpoint-light(-Base) tabanlı
//! - `Normal` ← base-checkpoint-normal(-Base) tabanlı
//!
