...
impl DatasetMetadata {
    ...
    /// chain "this StorageDeal is safe for AI inference layer to read as a training corpus".
...
/// The closed-circuit source kinds: the only three channels AI inference layer can read.
///
