...
#![forbid(unsafe_code)]
//! # ai-inference-knowledge - the closed-circuit knowledge layer
//!
//! Produces knowledge from source code and documents while keeping the AI inference layer's
...
//! files this crate produces and in the AI inference layer's own B.U.D. records.
