...
//!
//! [`crate::config::ServeEngine::ResidentBatch`] and `ResidentGraph` require the whole model
...
impl ResidencyPlan {
    ...
    /// panicking.
    pub fn rebalance(&self, heat: &RoutingHeat, budget: DeviceBudget) -> Result<Self, PlanError> {
