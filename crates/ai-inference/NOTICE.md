...
AI inference layer builds on the third-party works below. This notice is the technical form
of the attribution policy: copied third-party code and weight names are kept as
they are, and the name "the AI inference layer" is used only for our own layer.
...
- AI inference layer fine-tuning outputs are named "the AI inference layer-{version} (based on
