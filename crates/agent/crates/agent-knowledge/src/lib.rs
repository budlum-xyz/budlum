...
#![forbid(unsafe_code)]
//! # agent-knowledge - the closed-circuit knowledge layer
//!
//! Produces knowledge from source code and documents while keeping Agent's
...
//! files this crate produces and in Agent's own B.U.D. records.
