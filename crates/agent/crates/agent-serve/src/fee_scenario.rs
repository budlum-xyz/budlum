...
//! * **Agent serving** - token-metered like an API: every prompt debits its
...
/// A Agent wallet, debited token by token as prompts run.
...
mod fee_scenario_tests {
    ...
    #[test]
    fn agent_charge_debits_tokens_times_rate() {
    ...
    #[test]
    fn agent_charge_fails_when_the_balance_is_short() {
