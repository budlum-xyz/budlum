...
//! `AiDatasetMetadata` in budlum/main `src/agent/mod.rs` (mirror types).
//!
...
impl DatasetMetadata {
    ...
    /// chain "this StorageDeal is safe for Agent to read as a training corpus".
...
/// The closed-circuit source kinds: the only three channels Agent can read.
///
