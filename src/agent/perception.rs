//! What a Agent model is allowed to read, and in what form.
//!
//! Agent already answers "may this operator touch this data" through Pollen.
...
//! # Reading only
//!
//! Agent does not generate images or video, and nothing here opens a door to
...
//! `agent::admit_inference_request` on both executor paths.
...
pub enum PerceptionKind {
    ...
    /// Read video frames.
    ///
    /// Reading only. Agent does not produce video, and the absence of a
...
mod tests {
    ...
    fn reading_modalities_have_no_generating_counterpart() {
        ...
        // Agent reads; it does not generate images or video. A generation
