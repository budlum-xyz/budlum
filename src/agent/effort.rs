//! Agent effort tiers - how hard an operator is asked to work on a request.
//!
//! A Agent operator answers with the machine it actually owns. A small CPU can
...
//!    the requested depth.
//!
//! Deliberately *not* decided here: the fee multiplier. Agent costs are paid to
...
mod tests {
    ...
    /// verifier can run Agent at that depth.
    #[test]
