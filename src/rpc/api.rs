...
pub trait BudlumApi {
    ...
    /// `AgentOperatorBond` (RoleId 8) transaction. Bonding == registration;
    ...
    /// Agent readiness: chain-derived bonded operator count plus explicit
    /// Fail-closed flags for scheduler, worker, proof, and settlement wiring.
    #[method(name = "bud_agentStats")]
