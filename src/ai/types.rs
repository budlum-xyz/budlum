...
/// The canonical commitment over an input ref: `AI_INFERENCE_INPUT_COMMIT_V1`
...
pub fn canonical_input_commitment(input_ref: &[u8]) -> [u8; 32] {
    let mut hasher = Sha256::new();
    hasher.update(b"AI_INFERENCE_INPUT_COMMIT_V1");
...
/// AI inference result submitted by an active bonded the AI inference layer operator (RoleId 8).
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
