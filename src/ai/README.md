...
**Modül-ayrımı kuralı gereği AI layer'ın kendi README'sidir.**
...
- **Attestation model (-1).** On-chain AI inference = off-chain hesaplama +
...
- **Determinizm riski.** Aynı model farklı donanımda farklı çıktı verebilir →
...
- **AI ↔ B.U.D./Pollen AccessGrant admission gate.**
