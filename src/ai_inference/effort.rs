//! AI inference layer effort tiers - how hard an operator is asked to work on a request.
//!
//! A the AI inference layer operator answers with the machine it actually owns. A small CPU can
...
//!    the requested depth.
//!
//! Deliberately *not* decided here: the fee multiplier. the AI inference layer costs are paid to
...
mod tests {
    ...
    /// verifier can run the AI inference layer at that depth.
    #[test]
