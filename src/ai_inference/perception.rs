//! What an AI inference layer model is allowed to read, and in what form.
//!
...
pub enum PerceptionKind {
    ...
    /// Read video frames.
    ///
    /// Reading only. AI inference layer does not produce video, and the absence of a
