...
//!
//! Tracks the running state of the AI inference layer: total queries, successful
//! verifications, slashed operators and the number of active models. Intended
//! for monitoring and dashboards.

use std::sync::atomic::{AtomicU64, Ordering};

/// The metrics of the AI inference layer, as thread-safe atomic counters.
...
impl AiMetrics {
    ...
    #[must_use]
    pub fn summary(&self) -> AiMetricsSnapshot {
        AiMetricsSnapshot {
...
impl std::fmt::Display for AiMetricsSnapshot {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "AI inference layer{{queries={}, verified={}, slashed={}, models={}, fee_volume={}}}",
            self.total_queries,
