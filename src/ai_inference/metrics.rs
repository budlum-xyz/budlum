//! AI inference layer metrikleri - sorgu/verifier/operator istatistik takibi.
//!
//! Tracks the running state of the the AI inference layer layer: total queries, successful
//! verifications, slashed operators and the number of active models. Intended
//! for monitoring and dashboards.

use std::sync::atomic::{AtomicU64, Ordering};

/// The metrics of the the AI inference layer layer, as thread-safe atomic counters.
...
impl AiInferenceMetrics {
    ...
    #[must_use]
    pub fn summary(&self) -> AiInferenceMetricsSnapshot {
        AiInferenceMetricsSnapshot {
...
pub struct AiInferenceMetricsSnapshot {
...
impl std::fmt::Display for AiInferenceMetricsSnapshot {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "the AI inference layer{{queries={}, verified={}, slashed={}, models={}, fee_volume={}}}",
            self.total_queries,
