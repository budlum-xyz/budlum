    ...
    fn from(tx: &Transaction) -> Self {
        let (tx_type_i32, type_payload) = match &tx.tx_type {
            ...
            TransactionType::AgentOperatorBond => {
                (pb::ProtoTransactionType::AgentOperatorBond as i32, None)
            }
            TransactionType::AgentOperatorUnbond => {
                (pb::ProtoTransactionType::AgentOperatorUnbond as i32, None)
            }
            TransactionType::AgentOperatorWithdraw => {
                (pb::ProtoTransactionType::AgentOperatorWithdraw as i32, None)
            }
...
impl TryFrom<pb::ProtoTransaction> for Transaction {
    ...
    fn try_from(proto: pb::ProtoTransaction) -> Result<Self, Self::Error> {
        ...
        let tx_type = match tx_type_proto {
            ...
            pb::ProtoTransactionType::AgentOperatorBond => TransactionType::AgentOperatorBond,
            pb::ProtoTransactionType::AgentOperatorUnbond => TransactionType::AgentOperatorUnbond,
            pb::ProtoTransactionType::AgentOperatorWithdraw => {
                TransactionType::AgentOperatorWithdraw
            }
            ...
            pb::ProtoTransactionType::AiModelRegister => {
                ...
                TransactionType::AiModelRegister(crate::ai::types::AiModelSpec {
                    ...
                    modalities: if payload.modality_bits == 0 {
                        ...
                        crate::agent::perception::ModalitySet::from_bits(payload.modality_bits)
                    },
                })
            }
