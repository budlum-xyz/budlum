...
impl DomainProfile {
    ...
    #[must_use]
    /// WIRING: wired - read by `bud_getExternalDomainProfile` through
    /// `Blockchain::external_domain_profile`.
    ...
    #[must_use]
    /// WIRING: wired - `bud_getExternalDomains` prints this line for the
    /// same operator surface as `staleness`.
