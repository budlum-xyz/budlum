...
## AccessGrant v2 kararları

Address-bağlı grant · değişmez kapsam · ayrı-ödeme · zincir-üstü ReadOnce ·
tek-buyer · SaleAuthorization. Soft-enforcement üstüne HPKE hard-enforcement.

## Olgunluk uyarıları

- **-1 = protocol admission enforcement.** AI inference request, Pollen
