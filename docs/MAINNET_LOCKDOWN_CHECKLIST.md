# Mainnet Lockdown Checklist — Task 11.20
...
**Scope:** final pre-launch review after Task 11.6 → 11.20 evidence is present.
...
| Wallet core | `Wallet Core (Task 11.14)` | Must be green |
| Governance | `Governance Invariants (Task 11.16)` | Must be green |
| PoA compliance isolation | `PoA Compliance Isolation (Task 11.18)` and legacy PoA isolation gate | Must be green |
| Audit/HSM docs | `Audit Prep (Task 11.20)`, validator key-management, HSM policy | Must be green |
...
6. Confirm all Task 11.8, 11.10, 11.12, 11.14, 11.16, 11.18 and 11.20 gates are green on main.
